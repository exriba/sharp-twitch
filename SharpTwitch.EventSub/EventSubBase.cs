...
namespace SharpTwitch.EventSub
{
    ...
    public abstract class EventSubBase
    {
        ...
        public abstract void RaiseEvent(SubscriptionType subscriptionType, EventArgs args);
        ...
        public abstract void RaiseErrorEvent(SubscriptionType subscriptionType, Exception exception);
    }
}
